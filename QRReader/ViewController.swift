...
class ViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            let destinationVC = segue.destination as! kalipdetay
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        if metadataObjects != nil && metadataObjects.count != 0
        {
            if let object = metadataObjects[0] as? AVMetadataMachineReadableCodeObject
            {
                ...
                {
                    let alert = UIAlertController(title: "Kalıp numarası doğru mu?", message: object.stringValue, preferredStyle: .alert)
                    ...
                    alert.addAction(UIAlertAction(title: "Evet", style: .default, handler: { (nil) in
                        ...
                        self.performSegue(withIdentifier: "1to2", sender: nil)
